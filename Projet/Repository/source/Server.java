 ...
 * @throws SAXException 
  ...
  public static void main(final String args[]) throws ParserConfigurationException, SAXException, IOException {
    ...
    // rÈcupÈration des arguments
    if (args.length!=1){
      System.out.println("Server <port du registry> <nom gÈnÈrique du fichier xml>");
      System.exit(1);
    }
    try  {
...
//    if(System.getSecurityManager()==null){
  ...
  //  }
    ...
    try {
	    ...
	    /* r√©cup√©ration des h√¥tels de la cha√Æne dans le fichier xml pass√© en 2nd argument */
	    ...
	    NamedNodeMap attrs;
	    /* acquisition de toutes les entr√©es de la base d'h√¥tels */
    ...
    try {
	    ...
	    System.out.println("Tous les objets sont enregistrÈs dans le serveur d'objets distants");
    } catch (Exception e) {
